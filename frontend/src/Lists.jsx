                    ...
                    {lists.map(list => {
                        return (
                            <Card key={list['name']} className="mt-2">
                                ...
                                <Card.Footer>
                                    <small className="text-muted">Last updated {dayjs(list['updated_at']).format("MMMM D, YYYY")} - <a href="#" role="button" className="text-reset text-decoration-none" onClick={(e) => handleEdit(e, list)}>edit</a></small>
                                </Card.Footer>
                            </Card>
                        )
                    })}
